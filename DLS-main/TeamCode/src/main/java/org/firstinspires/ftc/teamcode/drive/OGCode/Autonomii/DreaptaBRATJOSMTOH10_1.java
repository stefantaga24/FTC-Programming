...
public class DreaptaBRATJOSMTOH10_1 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence GO_TO_NEXT_POSITION = drive.trajectorySequenceBuilder(PLACE_PRELOAD.end())
                .lineTo(new  Vector2d(x_INTER_LT, y_INTER_LT))
                .splineToSplineHeading(new Pose2d(x_INTER_STS,y_INTER_STS,Math.toRadians(angle_INTER_STS)),Math.toRadians(180))
                .lineTo(new Vector2d(x_INTER_LT2,y_INTER_LT2))
                .lineToLinearHeading(new Pose2d(x_INTER_LTL,y_INTER_LTL,Math.toRadians(angle_INTER_LTL)))
                .build();
