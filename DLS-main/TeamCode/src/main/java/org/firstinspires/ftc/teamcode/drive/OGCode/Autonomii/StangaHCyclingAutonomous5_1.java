...
public class StangaHCyclingAutonomous5_1 extends LinearOpMode {
    enum STROBOT
    {
        START,
        FIRST_CYCLE,
    ...
    public static double x_CYCLING_POSITION = -37, y_CYCLING_POSITION = -5.5, Angle_CYCLING_POSITION = 195;
    public static double x_PARK1 = -57, y_PARK1 = -17, Angle_PARK1 = 90;
