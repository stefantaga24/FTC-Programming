...
import org.firstinspires.ftc.teamcode.drive.OGCode.AutoControllers.CyclingSouth;
import org.firstinspires.ftc.teamcode.drive.OGCode.AutoControllers.CyclingSouth;
...
public class DreaptaCyclingSouth extends LinearOpMode {
    enum STROBOT
    {
        START,
        FIRST_CYCLE,
    ...
    public void runOpMode() throws InterruptedException {
        ...
        CyclingSouth autoController101 = new CyclingSouth();
            ...
            switch (status)
            {
                ...
                case PRELOAD:
                {
                    if (!drive.isBusy())
                    {
                        ...
                        servo4BarController.Collect_Position = Servo4BarController.CyclingSouthPositions[5];
                        ...
                        turnClawController.CurrentStatus = TurnClawController.TurnClawStatus.COLLECT;
                        angle4BarController.CurrentStatus = Angle4BarController.angle4BarStatus.VERTICAL;
                        motorColectareController.CurrentStatus = MotorColectareController.MotorColectare.EXTENDED_10_1_SOUTH;
                        timerLift.reset();
