...
import org.firstinspires.ftc.teamcode.drive.OGCode.AutoControllers.AutoSouthHighJunction9_1;
...
public class DreaptaPushiPush1_9 extends LinearOpMode {
    enum STROBOT
    {
        START,
        GET_LIFT_DOWN,
    ...
    public void runOpMode() throws InterruptedException {
        ...
        AutoSouthHighJunction9_1 autoControllerTurn51 = new AutoSouthHighJunction9_1();
            ...
            switch (status) {
                ...
                case COLLECT:
                {
                    if (timeCollect.seconds()>0.2)
                    {
                        ...
                        nr++;
                        autoControllerTurn51.CurrentStatus = AutoSouthHighJunction9_1.autoControllerSouthHigh.STACK_LEVEL;
