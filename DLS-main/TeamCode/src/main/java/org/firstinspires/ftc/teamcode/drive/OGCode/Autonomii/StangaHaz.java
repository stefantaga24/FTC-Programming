...
import org.firstinspires.ftc.teamcode.drive.OGCode.AutoControllers.AutoController5_1_LEFT;
...
public class StangaHaz extends LinearOpMode {
    enum STROBOT
    {
        START,
        FIRST_CYCLE,
    ...
    public static double x_PLACE_PRELOAD = -37, y_PLACE_PRELOAD = 3, Angle_PLACE_PRELOAD = 160;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        AutoController5_1_LEFT autoController51 = new AutoController5_1_LEFT();
        ...
        while (opModeIsActive() && !isStopRequested())
        {
            ...
            switch (status)
            {
                ...
                case FIRST_CYCLE:
                {
                    ...
                    {
                        motorColectareController.NrConAuto = 5;
                        autoController51.CurrentStatus = AutoController5_1_LEFT.autoControllerStatus.STACK_LEVEL;
                ...
                case SECOND_CYCLE:
                {
                    if (autoController51.CurrentStatus == AutoController5_1_LEFT.autoControllerStatus.NOTHING)
                    {
